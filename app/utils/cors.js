...
module.exports = async (ctx, next) => {
    ...
    ctx.set('Access-Control-Allow-Headers', 'authorization, x-requested-with, accept, origin, content-type, x-kopernio-plugin-version'); // 字段是必需的。它也是一个逗号分隔的字符串，表明服务器支持的所有头信息字段.
